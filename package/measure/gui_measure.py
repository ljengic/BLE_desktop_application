...
class Ui_Measure(object):
    def setupUi(self, Measure):
        ...
        self.frame_14.setMinimumSize(QtCore.QSize(500, 200))
        self.frame_14.setMaximumSize(QtCore.QSize(500, 200))
        ...
        self.widget_top.setMinimumSize(QtCore.QSize(0, 150))
        self.widget_top.setMaximumSize(QtCore.QSize(16777215, 150))
        self.widget_top.setObjectName("widget_top")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout(self.widget_top)
        ...
        self.display_age = QtWidgets.QLabel(self.widget_9)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.display_age.setFont(font)
        self.display_age.setObjectName("display_age")
        self.verticalLayout_18.addWidget(self.display_age)
    ...
    def retranslateUi(self, Measure):
        ...
        self.label_28.setText(_translate("Measure", "Patinet #nesto"))
        self.label_29.setText(_translate("Measure", "male/female"))
        self.label_22.setText(_translate("Measure", "Age:"))
        self.label_23.setText(_translate("Measure", "Height:"))
        self.label_24.setText(_translate("Measure", "Weight:"))
        self.display_age.setText(_translate("Measure", "85 years"))
        self.display_height.setText(_translate("Measure", "186 cm"))
        self.display_weight.setText(_translate("Measure", "120 kg"))
