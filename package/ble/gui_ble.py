...
class Ui_BLE(object):
    def setupUi(self, BLE):
        ...
        self.frame_2.setMinimumSize(QtCore.QSize(500, 170))
        self.frame_2.setMaximumSize(QtCore.QSize(450, 170))
        ...
        self.label_ble_info = QtWidgets.QLabel(self.widget_5)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_ble_info.setFont(font)
        self.label_ble_info.setObjectName("label_ble_info")
        self.verticalLayout_6.addWidget(self.label_ble_info)
        ...
        self.frame_5.setMinimumSize(QtCore.QSize(140, 140))
        self.frame_5.setMaximumSize(QtCore.QSize(120, 140))
        ...
        self.label_conn_status = QtWidgets.QLabel(self.frame_5)
        font = QtGui.QFont()
        ...
        self.verticalLayout_5.addWidget(self.label_conn_status)
        self.horizontalLayout_3.addWidget(self.frame_5)
        self.horizontalLayout_8.addWidget(self.frame_2)
        spacerItem3 = QtWidgets.QSpacerItem(494, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.btn_scan.setMinimumSize(QtCore.QSize(150, 40))
        self.btn_scan.setObjectName("btn_scan")
        self.horizontalLayout_2.addWidget(self.btn_scan)
        spacerItem4 = QtWidgets.QSpacerItem(98, 37, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.frame_7.setMinimumSize(QtCore.QSize(350, 400))
        ...
        self.btn_connect.setMinimumSize(QtCore.QSize(150, 40))
        ...
        self.btn_disconnect = QtWidgets.QPushButton(self.page_2)
        self.btn_disconnect.setMinimumSize(QtCore.QSize(150, 40))
        ...
        self.label_inf_name = QtWidgets.QLabel(self.widget_4)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_inf_name.setFont(font)
        self.label_inf_name.setObjectName("label_inf_name")
        self.verticalLayout_8.addWidget(self.label_inf_name)
        self.label_inf_type = QtWidgets.QLabel(self.widget_4)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_inf_type.setFont(font)
        self.label_inf_type.setObjectName("label_inf_type")
        self.verticalLayout_8.addWidget(self.label_inf_type)
        self.label_inf_rssi = QtWidgets.QLabel(self.widget_4)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_inf_rssi.setFont(font)
        self.label_inf_rssi.setObjectName("label_inf_rssi")
        self.verticalLayout_8.addWidget(self.label_inf_rssi)
        self.label_inf_address = QtWidgets.QLabel(self.widget_4)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_inf_address.setFont(font)
        self.label_inf_address.setObjectName("label_inf_address")
        self.verticalLayout_8.addWidget(self.label_inf_address)
        spacerItem8 = QtWidgets.QSpacerItem(20, 187, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, BLE):
        ...
        self.label.setText(_translate("BLE", "Connection status:"))
        self.label_ble_info.setText(_translate("BLE", "Please scan availabe BLE devices and \n"
"choose device to connect"))
        self.label_conn_status.setText(_translate("BLE", "Disconnected"))
        self.btn_scan.setText(_translate("BLE", "Scan"))
        self.label_9.setText(_translate("BLE", "List of discovered BLE devices"))
        self.btn_connect.setText(_translate("BLE", "Connect"))
        self.label_3.setText(_translate("BLE", "Selected device informations:"))
        self.btn_disconnect.setText(_translate("BLE", "Disconnect"))
        self.label_4.setText(_translate("BLE", "Connected device informations:"))
        self.label_5.setText(_translate("BLE", "Name:"))
        self.label_6.setText(_translate("BLE", "Type:"))
        self.label_7.setText(_translate("BLE", "Rssi:"))
        self.label_8.setText(_translate("BLE", "Address:"))
        self.label_inf_name.setText(_translate("BLE", "TextLabel"))
        self.label_inf_type.setText(_translate("BLE", "TextLabel"))
        self.label_inf_rssi.setText(_translate("BLE", "TextLabel"))
        self.label_inf_address.setText(_translate("BLE", "TextLabel"))
import resources_rc
