...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-human-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_patient_2.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-start-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_start_2.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-result-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_results_2.setIcon(icon5)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 513, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-close-120.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_patient_1.setIcon(icon3)
        ...
        self.btn_start_1.setIcon(icon4)
        ...
        self.btn_results_1.setIcon(icon5)
