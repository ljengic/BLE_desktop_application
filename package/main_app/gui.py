...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_ble = QtWidgets.QLabel(self.status_bar)
        self.label_ble.setMinimumSize(QtCore.QSize(30, 30))
        self.label_ble.setMaximumSize(QtCore.QSize(30, 30))
        self.label_ble.setFrameShape(QtWidgets.QFrame.Box)
        self.label_ble.setFrameShadow(QtWidgets.QFrame.Raised)
        self.label_ble.setText("")
        self.label_ble.setPixmap(QtGui.QPixmap(":/icons/icons/ble_off.png"))
        self.label_ble.setScaledContents(True)
        self.label_ble.setAlignment(QtCore.Qt.AlignCenter)
        self.label_ble.setObjectName("label_ble")
        self.horizontalLayout.addWidget(self.label_ble)
